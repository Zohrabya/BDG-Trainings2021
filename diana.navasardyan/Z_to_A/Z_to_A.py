...
first_element = browser.find_element(By.XPATH, "//div[contains(text(),'Test.allTheThings() T-Shirt (Red)')]").text
second_element = browser.find_element(By.XPATH, "//div[contains(text(),'Sauce Labs Onesie')]").text
third_element = browser.find_element(By.XPATH,"//div[contains(text(),'Sauce Labs Fleece Jacket')]").text

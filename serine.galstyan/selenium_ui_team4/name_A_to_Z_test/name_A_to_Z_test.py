...
chrome_driver.find_element(By.XPATH, "//option[@value='az']").click()
first_item_title = chrome_driver.find_element(By.XPATH, "//div[contains(text(),'Sauce Labs Backpack')]").text
second_item_title = chrome_driver.find_element(By.XPATH, "//div[contains(text(),'Sauce Labs Bike Light')]").text

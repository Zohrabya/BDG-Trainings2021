...
try:
    ...
    #Test case 1. Test if a user can't checkout with blank user information form
    ...
    #Test case 2. Test if an error message appears if user tries to checkout with blank user information form
    try:
        error_message = browser.find_element_by_xpath("//h3[contains(text(), 'Error')]")
